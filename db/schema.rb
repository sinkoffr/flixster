...
ActiveRecord::Schema.define(version: 20171101184658) do
  ...
  create_table "enrollements", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["course_id"], name: "index_enrollements_on_course_id", using: :btree
    t.index ["user_id", "course_id"], name: "index_enrollements_on_user_id_and_course_id", using: :btree
  end
